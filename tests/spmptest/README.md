...
#### 异常优先级测试
输入make ARCH=riscv64-xs mainargs=p 开启优先级测试。
在3次spmptest之前穿插3次pmp测试（表明确实会发生pmp异常），每一次pmp测试完成之后无需清除pmp寄存器的信息，
供后面spmp检查时，将pmp检查一同参与进来，达到优先级测试的目的。

##### U模式下测试时16个PMP寄存器配置情况

| index | PMP寄存器序号   | 起始地址    | 大小        | rwx  | 对照权限结果(0xwr) |
| ----- | -------------- | ---------- | ----------- | ---- | ------------------ |
| 0     | 0              | 0x80010000 | 0x1000      | 0    | 7                  |
| 1     | 1              | 0x80011000 | 0x1000      | 4    | 6                  |
| 2     | 2              | 0x80012000 | 0x1000      | 1    | 5                  |
| 3     | 3              | 0x80013000 | 0x1000      | 3    | 1                  |
| 4     | 4              | 0x80014000 | 0x1000      | 1    | 5                  |
| 5     | 5              | 0x80015000 | 0x1000      | 5    | 4                  |
| 6     | 6              | 0x80016000 | 0x1000      | 3    | 1                  |
| 7     | 7              | 0x80017000 | 0x1000      | 1    | 5                  |
| 8     | 8              | 0x80018000 | 0x1000      | 0    | 7                  |
| 9     | 9              | 0x80019000 | 0x1000      | 0    | 7                  |
| 10    | 10             | 0x8001a000 | 0x1000      | 4    | 6                  |
| 11    | 11             | 0x8001b000 | 0x1000      | 4    | 6                  |
| 12    | 12             | 0x8001c000 | 0x1000      | 0    | 6                  |
| 13    | 13             | 0x8001d000 | 0x1000      | 0    | 6                  |
| 14    | 14             | 0x8001e000 | 0x1000      | 0    | 6                  |
| 15    | 15             | 0x0        | 0x100000000 | 7    | 0                  |

##### S模式下测试时16个PMP寄存器配置情况（sum=0）

| index | PMP寄存器序号   | 起始地址    | 大小        | rwx  | 对照权限结果(0xwr) |
| ----- | -------------- | ---------- | ----------- | ---- | ------------------ |
| 0     | 0              | 0x80010000 | 0x1000      | 0    | 7                  |
| 1     | 1              | 0x80011000 | 0x1000      | 0    | 7                  |
| 2     | 2              | 0x80012000 | 0x1000      | 3    | 1                  |
| 3     | 3              | 0x80013000 | 0x1000      | 3    | 1                  |
| 4     | 4              | 0x80014000 | 0x1000      | 0    | 7                  |
| 5     | 5              | 0x80015000 | 0x1000      | 0    | 7                  |
| 6     | 6              | 0x80016000 | 0x1000      | 0    | 7                  |
| 7     | 7              | 0x80017000 | 0x1000      | 0    | 7                  |
| 8     | 8              | 0x80018000 | 0x1000      | 0    | 7                  |
| 9     | 9              | 0x80019000 | 0x1000      | 4    | 6                  |
| 10    | 10             | 0x8001a000 | 0x1000      | 4    | 6                  |
| 11    | 11             | 0x8001b000 | 0x1000      | 5    | 4                  |
| 12    | 12             | 0x8001c000 | 0x1000      | 1    | 5                  |
| 13    | 13             | 0x8001d000 | 0x1000      | 5    | 4                  |
| 14    | 14             | 0x8001e000 | 0x1000      | 3    | 1                  |
| 15    | 15             | 0x0        | 0x100000000 | 7    | 0                  |

##### S模式下测试时16个PMP寄存器配置情况(sum=1)
...
| 3     | 3              | 0x80013000 | 0x1000      | 3    | 1                  |
| 4     | 4              | 0x80014000 | 0x1000      | 1    | 5                  |
| 5     | 5              | 0x80015000 | 0x1000      | 1    | 5                  |
| 6     | 6              | 0x80016000 | 0x1000      | 3    | 1                  |
| 7     | 7              | 0x80017000 | 0x1000      | 3    | 1                  |
| 8     | 8              | 0x80018000 | 0x1000      | 0    | 7                  |
| 9     | 9              | 0x80019000 | 0x1000      | 4    | 6                  |
| 10    | 10             | 0x8001a000 | 0x1000      | 4    | 6                  |
| 11    | 11             | 0x8001b000 | 0x1000      | 5    | 4                  |
